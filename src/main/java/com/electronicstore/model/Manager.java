...
public class Manager extends User{
    ...
    public Manager(int id, String name, String username, Date date_of_birth, int phoneNumber, String email, double salary, String password, String access_level,ArrayList<Sector> sector,ArrayList<Supplier> suppliers,ArrayList<Category>categories)
    {
