            ...
            dialog.setResultConverter(dialogButton -> {
                if (dialogButton == addButtonType) {
                    try {
                        ...
                        User newUser = new User(id, name, username, java.sql.Date.valueOf(dob), phone, email, salary, password, roleAdd, sectorName);
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath))) {
            ...
            for (User user : users) {
                writer.write(user.getId() + "," +
                        ...
                        (user.getSectorName() != null ? user.getSectorName() : null));
                writer.newLine();
            }
    ...
    private void showEditDialog(User user) {
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == okButtonType) {
                ...
                user.setSectorName(sectorComboBox.getValue()); // Update the sector
            }
            return null;
        });
