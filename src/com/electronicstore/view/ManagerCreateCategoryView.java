...
public class ManagerCreateCategoryView extends Application {
    ...
    public void start(Stage primaryStage){
        ...
        addNewCategory.setStyle("-fx-text-fill: rgb(0, 0, 0); -fx-font-weight: bold; -fx-font-size:20 ");
        ...
        createCategoryButton.setStyle("-fx-background-color: rgb(19, 68, 121); -fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 16px; -fx-background-radius: 20;");
        center.add(createCategoryButton, 0, 3, 2, 1);
        GridPane.setHalignment(createCategoryButton, javafx.geometry.HPos.CENTER);
