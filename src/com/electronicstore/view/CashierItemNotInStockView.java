...
public class CashierItemNotInStockView extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        Label itemNoStock=new Label("This item is not in stock");
        itemNoStock.setStyle("-fx-text-fill: rgb(187, 0, 0); -fx-font-size:14 ");
        center.add(itemNoStock, 0, 3);
        ...
        center.add(createBillButton, 0, 5, 2, 1);
